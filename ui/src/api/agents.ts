...
export const agentsApi = {
  ...
  bulkPause: (companyId: string) => api.post<{ pausedCount: number }>(`/companies/${companyId}/agents/bulk/pause`, {}),
  bulkResume: (companyId: string) => api.post<{ resumedCount: number }>(`/companies/${companyId}/agents/bulk/resume`, {}),
