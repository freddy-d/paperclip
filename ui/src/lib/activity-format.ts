...
const ACTIVITY_ROW_VERBS: Record<string, string> = {
  ...
  "client.instructions_file_updated": "updated instructions on",
  "client.instructions_file_deleted": "deleted instructions from",
...
const ISSUE_ACTIVITY_LABELS: Record<string, string> = {
  ...
  "client.instructions_file_updated": "updated client instructions",
  "client.instructions_file_deleted": "deleted client instructions",
